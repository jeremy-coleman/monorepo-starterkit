...
import { IComponent, ComponentTypes, Dashboard, DashboardList, Defaults, Grid, HSplit, IDashboard, IWindow, Stack, VSplit, Window, WindowResizeType, IWindowManager, IComponentFactory, ComponentFactory } from "./models"
import { addDashboard, clearDashboards, DashboardAdd, ComponentRemoveStore, DashboardAddStore, DashboardListClearStore, DashboardRemoveStore, removeComponent, removeDashboard } from "./stores"
...
export class ComponentRemove {
  _saveHandler: (component: IComponent) => void
...
// export class WindowAppHost1 extends IAppHost {
//   _window: IWindow
...
const renderView = (comp: IComponent) => {
  return when(comp && comp.type as keyof typeof ComponentTypes)
