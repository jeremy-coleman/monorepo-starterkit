import { IImage as UIFabricImage, Image } from "office-ui-fabric-react"
...
export const ImageFile = (props: IImageFileProps) => {
  var _blobUrl: string
...
export const ImageField = (props: IImageFieldProps) => {
  // var _ref = useRef<HTMLInputElement>()
  // var _id = useId("image-field")
  // var state = useState({})
